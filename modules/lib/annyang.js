...
//! annyang
//! version : 2.6.0
//! author  : Tal Ater @TalAter, ammended in parts by JLB for VoiceCommander extension
//! license : MIT
...
(function (root, factory) {
  ...
  //Current confidence stores the confidence of the current SpeechRecognitionResultAlternativ Objects
  ...
  var logMessage = function logMessage(text, extraParameters) {
    if (text.indexOf('%c') === -1 && !extraParameters) {
      console.log('VC-EXT: ' +text);
    } else {
      console.log('VC-EXT: ' +text, extraParameters || debugStyle);
    }
  };
  ...
  annyang = {
    ...
    init: function init(commands) {
      ...
      recognition.onresult = function (event) {
        ...
        for (var k = 0; k < SpeechRecognitionResult.length; k++) {
          ...
          currentConfidence = SpeechRecognitionResult[0].confidence;
        }
        phrases = results;
    ...
    /**
    * Returns the confidence of the browsers SpeechRecognitionResultAlternativ object that got matched with any given command.
    *
    *
    */
    getConfidence: function getConfidence(){
      return currentConfidence;
    },

    /**
    * Returns the phrases of the browsers SpeechRecognitionResultAlternativ object
    *
    *
    */
    getPhrases: function getPhrases(){
      return phrases;
    },
